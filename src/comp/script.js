 ...
 */
// Geometry
const waterGeometry = new THREE.PlaneGeometry(6, 6, 600, 600)

// Colors
debugObject.depthColor = '#000000'
debugObject.surfaceColor = '#313131'
...
camera.position.set(1.343679723284977, 0.13011463208952684, -1.0851744520468487)
scene.add(camera)
