...
function VideoText(props) {
  const [video] = useState(() => Object.assign(document.createElement('video'), { src: '/Website.mp4', crossOrigin: 'Anonymous', loop: true, muted: true }))
...
function Ground() {
  const [floor, normal] = useTexture(['/SurfaceImperfections004.jpg', '/SurfaceImperfections003.jpg'])
  return (
