...
function App() {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=11&tags=12&order=asc'
            )
            .then((res) => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=11&tags=13&order=asc'
            )
            .then((res) => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=15&tags=12&order=asc'
            )
            .then((res) => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=15&tags=16&order=asc'
            )
            .then((res) => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=15&tags=13&order=asc'
            )
            .then((res) => {
        ...
        axios
            .get(
                process.env.REACT_APP_WP +
                    'project?project_keys=15&tags=17&order=asc'
            )
            .then((res) => {
